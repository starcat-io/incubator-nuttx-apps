/****************************************************************************
 * examples/partition/partition_main.c
 *
 ****************************************************************************/
...
char *device_name = "/dev/sda";

/****************************************************************************
 * Private Function Prototypes
 ****************************************************************************/
static int parse_partition_prototypes(void);
...
static int parse_partition_table(void)
{
    ...
    if ((fd = open(device_name, O_RDONLY | O_SYNC)) == -1)
    {
        perror("Open");
        exit(1);
    }
